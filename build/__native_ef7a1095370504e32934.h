#ifndef MYPYC_NATIVE_ef7a1095370504e32934_H
#define MYPYC_NATIVE_ef7a1095370504e32934_H
#include <Python.h>
#include <CPy.h>
...
typedef struct {
    ...
    CPyVTableItem *vtable;
    PyObject *___mypyc_env__;
} dank_mids___helpers____requester___run_and_set_result_gen___3_71Object;
...
typedef struct {
    ...
    CPyVTableItem *vtable;
    PyObject *___mypyc_env__;
} dank_mids___helpers____requester___close_session_gen___3_126Object;
...
typedef struct {
    PyObject_HEAD
    CPyVTableItem *vtable;
    CPyTagged __capacity;
    CPyTagged __count;
    CPyTagged __index;
    double __total;
    VecFloat __values;
} dank_mids___stats____float_moving_average___FloatMovingAverageObject;
...
typedef struct {
    ...
    PyObject *___mypyc_generator_attribute__self;
    int32_t ___mypyc_next_label__;
    VecFloat ___mypyc_generator_attribute__values;
    CPyTagged ___mypyc_generator_attribute__count;
    CPyTagged ___mypyc_generator_attribute__capacity;
    CPyTagged ___mypyc_temp__0;
    CPyTagged ___mypyc_temp__1;
    CPyTagged ___mypyc_generator_attribute__index;
    CPyTagged ___mypyc_generator_attribute__start;
    CPyTagged ___mypyc_temp__2;
    CPyTagged ___mypyc_temp__3;
    CPyTagged ___mypyc_temp__4;
    CPyTagged ___mypyc_temp__5;
} dank_mids___stats____float_moving_average_____iter___3_FloatMovingAverage_genObject;
