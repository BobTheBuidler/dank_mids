...
PyMODINIT_FUNC
PyInit__float_moving_average(void)
{
    PyObject *tmp;
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_dank_mids___stats____float_moving_average");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "ef7a1095370504e32934__mypyc.init_dank_mids___stats____float_moving_average");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit__float_moving_average(); }
