...
PyInit__retry_mechanics(void)
{
    ...
    tmp = PyImport_ImportModuleLevel("a850d07634195e716572__mypyc", NULL, NULL, fromlist, 0);
    if (!tmp) return NULL;
    ...
    if (deps_capsule != NULL) {
        int (*deps_func)(void) = (int (*)(void))PyCapsule_GetPointer(
            deps_capsule, "a850d07634195e716572__mypyc.ensure_deps");
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_dank_mids___helpers____retry_mechanics");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "a850d07634195e716572__mypyc.init_dank_mids___helpers____retry_mechanics");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit__retry_mechanics(); }
