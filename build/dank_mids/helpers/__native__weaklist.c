...
CPyL2: ;
    ...
    if (unlikely(cpy_r_r1 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__init__", 13, CPyStatic_globals);
        goto CPyL9;
    }
...
__LL1: ;
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__init__", 11, CPyStatic_globals);
    return NULL;
}
...
PyObject *CPyDef_WeakList_____repr__(PyObject *cpy_r_self) {
    ...
    if (unlikely(cpy_r_r2 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__repr__", 19, CPyStatic_globals);
        goto CPyL8;
    }
    if (likely(PyUnicode_Check(cpy_r_r2)))
        cpy_r_r3 = cpy_r_r2;
    else {
        CPy_TypeErrorTraceback("dank_mids/helpers/_weaklist.py", "__repr__", 19, CPyStatic_globals, "str", cpy_r_r2);
        goto CPyL8;
    }
...
PyObject *CPyPy_WeakList_____repr__(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retval;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__repr__", 17, CPyStatic_globals);
    return NULL;
}
...
CPyTagged CPyDef_WeakList_____len__(PyObject *cpy_r_self) {
    ...
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__len__", "WeakList", "_refs", 22, CPyStatic_globals);
        goto CPyL2;
    }
    CPy_INCREF(cpy_r_r0);
CPyL1: ;
...
PyObject *CPyPy_WeakList_____len__(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__len__", 21, CPyStatic_globals);
    return NULL;
}
...
char CPyDef_WeakList_____bool__(PyObject *cpy_r_self) {
    ...
    cpy_r_r0 = ((dank_mids___helpers____weaklist___WeakListObject *)cpy_r_self)->__refs;
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__bool__", "WeakList", "_refs", 25, CPyStatic_globals);
        goto CPyL2;
    }
    CPy_INCREF(cpy_r_r0);
CPyL1: ;
...
PyObject *CPyPy_WeakList_____bool__(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__bool__", 24, CPyStatic_globals);
    return NULL;
}
...
char CPyDef_WeakList_____contains__(PyObject *cpy_r_self, PyObject *cpy_r_item) {
    ...
    cpy_r_r0 = ((dank_mids___helpers____weaklist___WeakListObject *)cpy_r_self)->__refs;
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__contains__", "WeakList", "_refs", 28, CPyStatic_globals);
        goto CPyL7;
    }
    CPy_INCREF(cpy_r_r0);
CPyL1: ;
    ...
    if (unlikely(cpy_r_r3 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__contains__", 28, CPyStatic_globals);
        goto CPyL7;
    }
    cpy_r_ref = cpy_r_r3;
...
CPyL4: ;
    ...
    if (unlikely(cpy_r_r7 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__contains__", 29, CPyStatic_globals);
        goto CPyL7;
    }
...
PyObject *CPyPy_WeakList_____contains__(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__contains__", 27, CPyStatic_globals);
    return NULL;
}
...
PyObject *CPyDef___iter___3_WeakList_gen_____mypyc_generator_helper__(PyObject *cpy_r___mypyc_self__, PyObject *cpy_r_type, PyObject *cpy_r_value, PyObject *cpy_r_traceback, PyObject *cpy_r_arg) {
    ...
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_gen", "__mypyc_env__", 31, CPyStatic_globals);
        goto CPyL58;
    }
    CPy_INCREF(cpy_r_r0);
CPyL1: ;
    ...
    if (unlikely(cpy_r_r1 == CPY_INT_TAG)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_next_label__", 31, CPyStatic_globals);
        goto CPyL59;
    }
...
CPyL3: ;
    ...
    if (unlikely(!0)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 31, CPyStatic_globals);
        goto CPyL58;
    }
    CPy_Unreachable();
CPyL5: ;
    ...
    if (unlikely(cpy_r_r4 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 32, CPyStatic_globals);
        goto CPyL59;
    }
    ...
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__0 = cpy_r_r4;
    cpy_r_r5 = 1;
    if (unlikely(!cpy_r_r5)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", -1, CPyStatic_globals);
        goto CPyL59;
    }
    cpy_r_r6 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_self;
    if (unlikely(cpy_r_r6 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "self", 32, CPyStatic_globals);
        goto CPyL59;
    }
    CPy_INCREF(cpy_r_r6);
CPyL8: ;
    cpy_r_r7 = ((dank_mids___helpers____weaklist___WeakListObject *)cpy_r_r6)->__refs;
    if (unlikely(cpy_r_r7 == NULL)) {
...
CPyL9: ;
    CPy_INCREF(cpy_r_r7);
    if (((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__1 != NULL) {
        CPy_DECREF(((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__1);
    }
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__1 = cpy_r_r7;
    cpy_r_r8 = 1;
    if (unlikely(!cpy_r_r8)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", -1, CPyStatic_globals);
        goto CPyL61;
    }
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__2 = 0;
    cpy_r_r9 = 1;
    if (unlikely(!cpy_r_r9)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", -1, CPyStatic_globals);
        goto CPyL61;
    }
    cpy_r_r10 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__1;
    if (unlikely(cpy_r_r10 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_temp__1", 32, CPyStatic_globals);
        goto CPyL61;
    }
    CPy_INCREF(cpy_r_r10);
CPyL12: ;
    cpy_r_r11 = PyDict_Size(cpy_r_r10);
    ...
    cpy_r_r14 = CPyDict_GetValuesIter(cpy_r_r7);
    CPy_DECREF(cpy_r_r7);
    if (unlikely(cpy_r_r14 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 32, CPyStatic_globals);
        goto CPyL59;
    }
    if (((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__4 != NULL) {
        CPy_DECREF(((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__4);
    }
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__4 = cpy_r_r14;
    cpy_r_r15 = 1;
...
CPyL15: ;
    cpy_r_r16 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__4;
    if (unlikely(cpy_r_r16 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_temp__4", 32, CPyStatic_globals);
        goto CPyL59;
    }
    CPy_INCREF(cpy_r_r16);
CPyL16: ;
    cpy_r_r17 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__2;
    if (unlikely(cpy_r_r17 == CPY_INT_TAG)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_temp__2", 32, CPyStatic_globals);
        goto CPyL62;
    }
CPyL17: ;
    cpy_r_r18 = CPyDict_NextValue(cpy_r_r16, cpy_r_r17);
    CPy_DECREF(cpy_r_r16);
    cpy_r_r19 = cpy_r_r18.f1;
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__2 = cpy_r_r19;
    cpy_r_r20 = 1;
    if (unlikely(!cpy_r_r20)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 32, CPyStatic_globals);
        goto CPyL63;
    }
    cpy_r_r21 = cpy_r_r18.f0;
    if (!cpy_r_r21) goto CPyL64;
    cpy_r_r22 = cpy_r_r18.f2;
    ...
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_r = cpy_r_r22;
    cpy_r_r23 = 1;
    if (unlikely(!cpy_r_r23)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 32, CPyStatic_globals);
        goto CPyL59;
    }
    cpy_r_r24 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_r;
    if (unlikely(cpy_r_r24 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "r", 32, CPyStatic_globals);
        goto CPyL59;
    }
...
CPyL21: ;
    ...
    cpy_r_r27 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_r;
...
CPyL23: ;
    cpy_r_r28 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__0;
    if (unlikely(cpy_r_r28 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_temp__0", -1, CPyStatic_globals);
        goto CPyL65;
    }
    CPy_INCREF(cpy_r_r28);
CPyL24: ;
    cpy_r_r29 = PyList_Append(cpy_r_r28, cpy_r_r27);
...
CPyL25: ;
    cpy_r_r31 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__1;
...
CPyL26: ;
    cpy_r_r32 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__3;
    if (unlikely(cpy_r_r32 == CPY_INT_TAG)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_temp__3", 32, CPyStatic_globals);
        goto CPyL66;
    }
CPyL27: ;
    cpy_r_r33 = CPyDict_CheckSize(cpy_r_r31, cpy_r_r32);
...
CPyL28: ;
    ...
    cpy_r_r35 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__0;
...
CPyL30: ;
    ...
    if (((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_refs != NULL) {
        CPy_DECREF(((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_refs);
    }
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_refs = cpy_r_r36;
    cpy_r_r37 = 1;
    ...
    cpy_r_r39 = CPyStatics[9]; /* '_get_obj_from_ref' */
    cpy_r_r40 = CPyDict_GetItem(cpy_r_r38, cpy_r_r39);
    if (unlikely(cpy_r_r40 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 33, CPyStatic_globals);
        goto CPyL59;
    }
    cpy_r_r41 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_refs;
    if (unlikely(cpy_r_r41 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "refs", 33, CPyStatic_globals);
        goto CPyL67;
    }
    CPy_INCREF(cpy_r_r41);
CPyL34: ;
    cpy_r_r42 = CPyModule_builtins;
    cpy_r_r43 = CPyStatics[7]; /* 'map' */
    cpy_r_r44 = CPyObject_GetAttr(cpy_r_r42, cpy_r_r43);
    if (unlikely(cpy_r_r44 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 33, CPyStatic_globals);
        goto CPyL68;
    }
    PyObject *cpy_r_r45[2] = {cpy_r_r40, cpy_r_r41};
    cpy_r_r46 = (PyObject **)&cpy_r_r45;
    cpy_r_r47 = _PyObject_Vectorcall(cpy_r_r44, cpy_r_r46, 2, 0);
    ...
    if (((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__5 != NULL) {
        CPy_DECREF(((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__5);
    }
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__5 = cpy_r_r47;
    cpy_r_r49 = 1;
    if (unlikely(!cpy_r_r49)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", -1, CPyStatic_globals);
        goto CPyL70;
    }
    if (((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__6 != NULL) {
        CPy_DECREF(((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__6);
    }
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__6 = cpy_r_r48;
    cpy_r_r50 = 1;
...
CPyL39: ;
    cpy_r_r51 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->___mypyc_temp__6;
    if (unlikely(cpy_r_r51 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "__mypyc_temp__6", 33, CPyStatic_globals);
        goto CPyL59;
    }
...
CPyL40: ;
    ...
    ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_obj = cpy_r_r52;
    cpy_r_r53 = 1;
    if (unlikely(!cpy_r_r53)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "__iter__", 33, CPyStatic_globals);
        goto CPyL59;
    }
    cpy_r_r54 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_obj;
    if (unlikely(cpy_r_r54 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "obj", 34, CPyStatic_globals);
        goto CPyL59;
    }
...
CPyL43: ;
    ...
    cpy_r_r57 = ((dank_mids___helpers____weaklist_____iter___3_WeakList_envObject *)cpy_r_r0)->_obj;
    if (unlikely(cpy_r_r57 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "__iter__", "__iter___WeakList_env", "obj", 35, CPyStatic_globals);
        goto CPyL59;
    }
...
CPyL47: ;
    ...
    cpy_r_r60 = cpy_r_type != cpy_r_r59;
    if (cpy_r_r60) {
        goto CPyL72;
    } else
        goto CPyL39;
...
CPyL50: ;
    ...
    CPy_Unreachable();
CPyL54: ;
    cpy_r_r64 = cpy_r_r1 == 0;
    if (cpy_r_r64) goto CPyL73;
    cpy_r_r65 = cpy_r_r1 == 2;
...
char CPyDef_WeakList___append(PyObject *cpy_r_self, PyObject *cpy_r_item) {
    ...
    char cpy_r_r12;
    char cpy_r_r13;
    cpy_r_r0 = CPyStatics[12]; /* '_gc_callback' */
    cpy_r_r1 = CPyObject_GetAttr(cpy_r_self, cpy_r_r0);
    if (unlikely(cpy_r_r1 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "append", 39, CPyStatic_globals);
        goto CPyL6;
    }
    cpy_r_r2 = CPyStatic_globals;
    cpy_r_r3 = CPyStatics[13]; /* 'ref' */
    ...
    if (unlikely(cpy_r_r8 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "append", "WeakList", "_refs", 39, CPyStatic_globals);
        goto CPyL8;
    }
    CPy_INCREF(cpy_r_r8);
CPyL4: ;
...
PyObject *CPyPy_WeakList___append(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "append", 37, CPyStatic_globals);
    return NULL;
}
...
char CPyDef_WeakList___extend(PyObject *cpy_r_self, PyObject *cpy_r_items) {
    ...
    cpy_r_r1 = CPyObject_GetAttr(cpy_r_self, cpy_r_r0);
    if (unlikely(cpy_r_r1 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "extend", 42, CPyStatic_globals);
        goto CPyL11;
    }
    cpy_r_r2 = ((dank_mids___helpers____weaklist___WeakListObject *)cpy_r_self)->__refs;
    if (unlikely(cpy_r_r2 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "extend", "WeakList", "_refs", 43, CPyStatic_globals);
        goto CPyL12;
    }
    CPy_INCREF(cpy_r_r2);
CPyL2: ;
    ...
    if (unlikely(cpy_r_r3 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "extend", 43, CPyStatic_globals);
        goto CPyL13;
    }
...
CPyL4: ;
    ...
    if (unlikely(cpy_r_r14 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp4 = CPyTagged_StealAsObject(cpy_r_r13.f0);
    PyTuple_SET_ITEM(cpy_r_r14, 0, __tmp4);
    PyObject *__tmp5 = cpy_r_r13.f1;
    PyTuple_SET_ITEM(cpy_r_r14, 1, __tmp5);
...
PyObject *CPyPy_WeakList___extend(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "extend", 41, CPyStatic_globals);
    return NULL;
}
...
char CPyDef_WeakList___remove(PyObject *cpy_r_self, PyObject *cpy_r_item) {
    ...
    if (unlikely(cpy_r_r1 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "remove", "WeakList", "_refs", 47, CPyStatic_globals);
        goto CPyL13;
    }
    CPy_INCREF(cpy_r_r1);
CPyL1: ;
    ...
    CPy_DECREF(cpy_r_r2);
    if (unlikely(cpy_r_r3 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "remove", 47, CPyStatic_globals);
        goto CPyL13;
    }
    cpy_r_ref = cpy_r_r3;
    cpy_r_r4 = (PyObject *)&_Py_NoneStruct;
    ...
    CPy_DECREF(cpy_r_ref);
    if (unlikely(cpy_r_r6 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "remove", 48, CPyStatic_globals);
        goto CPyL13;
    }
    ...
    if (cpy_r_r8) {
        ...
        goto CPyL9;
CPyL5: ;
    cpy_r_r9 = CPyStatics[14]; /* 'list.remove(x): x not in list' */
    cpy_r_r10 = CPyModule_builtins;
    cpy_r_r11 = CPyStatics[15]; /* 'ValueError' */
    cpy_r_r12 = CPyObject_GetAttr(cpy_r_r10, cpy_r_r11);
    if (unlikely(cpy_r_r12 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "remove", 49, CPyStatic_globals);
        goto CPyL12;
    }
...
CPyL9: ;
    ...
    if (unlikely(cpy_r_r16 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "remove", "WeakList", "_refs", 50, CPyStatic_globals);
        goto CPyL13;
    }
    CPy_INCREF(cpy_r_r16);
CPyL10: ;
...
PyObject *CPyPy_WeakList___remove(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "remove", 45, CPyStatic_globals);
    return NULL;
}
...
char CPyDef_WeakList____gc_callback(PyObject *cpy_r_self, PyObject *cpy_r_item) {
    ...
    cpy_r_r0 = ((dank_mids___helpers____weaklist___WeakListObject *)cpy_r_self)->__refs;
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AttributeError("dank_mids/helpers/_weaklist.py", "_gc_callback", "WeakList", "_refs", 54, CPyStatic_globals);
        goto CPyL3;
    }
    CPy_INCREF(cpy_r_r0);
CPyL1: ;
    cpy_r_r1 = CPyTagged_Id(cpy_r_item);
    cpy_r_r2 = CPyStatics[16]; /* 'pop' */
    ...
    if (unlikely(cpy_r_r7 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "_gc_callback", 54, CPyStatic_globals);
        goto CPyL4;
    } else
        goto CPyL5;
CPyL2: ;
...
PyObject *CPyPy_WeakList____gc_callback(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "_gc_callback", 52, CPyStatic_globals);
    return NULL;
}
...
char CPyDef___top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[35]; /* ('Any', 'Dict', 'Generic', 'Iterable', 'Iterator',
                                  'Optional', 'TypeVar') */
    cpy_r_r6 = CPyStatics[25]; /* 'typing' */
    cpy_r_r7 = CPyStatic_globals;
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[36]; /* ('ReferenceType', 'ref') */
    cpy_r_r10 = CPyStatics[27]; /* 'weakref' */
    ...
    CPyModule_weakref = cpy_r_r12;
    CPy_INCREF(CPyModule_weakref);
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[28]; /* '_T' */
    cpy_r_r14 = CPyStatic_globals;
    cpy_r_r15 = CPyStatics[24]; /* 'TypeVar' */
    ...
    cpy_r_r27 = CPyStatics[29]; /* '__call__' */
    ...
    cpy_r_r30 = CPyStatics[9]; /* '_get_obj_from_ref' */
    ...
    cpy_r_r34 = CPyStatics[20]; /* 'Generic' */
    ...
    cpy_r_r41 = CPyStatics[30]; /* 'dank_mids.helpers._weaklist' */
    cpy_r_r42 = (PyObject *)CPyType_WeakList_template;
    ...
    cpy_r_r44 = CPyDef_WeakList_trait_vtable_setup();
    if (unlikely(cpy_r_r44 == 2)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "<module>", -1, CPyStatic_globals);
        goto CPyL23;
    }
    cpy_r_r45 = CPyStatics[31]; /* '__mypyc_attrs__' */
    cpy_r_r46 = CPyStatics[32]; /* '_refs' */
    cpy_r_r47 = CPyStatics[33]; /* '__dict__' */
    cpy_r_r48 = PyTuple_Pack(2, cpy_r_r46, cpy_r_r47);
    if (unlikely(cpy_r_r48 == NULL)) {
        CPy_AddTraceback("dank_mids/helpers/_weaklist.py", "<module>", 10, CPyStatic_globals);
        goto CPyL23;
    }
    cpy_r_r49 = PyObject_SetAttr(cpy_r_r43, cpy_r_r45, cpy_r_r48);
    CPy_DECREF(cpy_r_r48);
    ...
    CPyType_WeakList = (PyTypeObject *)cpy_r_r43;
    CPy_INCREF(CPyType_WeakList);
    cpy_r_r51 = CPyStatic_globals;
    cpy_r_r52 = CPyStatics[34]; /* 'WeakList' */
    cpy_r_r53 = CPyDict_SetItem(cpy_r_r51, cpy_r_r52, cpy_r_r43);
...
PyObject *CPyStatics[37];
const char * const CPyLit_Str[] = {
    "\b\b__name__\002([\002, \004repr\003map\002])\021_get_obj_from_ref\rGeneratorExit",
    "\004\rStopIteration\f_gc_callback\003ref\035list.remove(x): x not in list",
    "\t\nValueError\003pop\bbuiltins\003Any\004Dict\aGeneric\bIterable\bIterator\bOptional",
    "\006\aTypeVar\006typing\rReferenceType\aweakref\002_T\b__call__",
    "\005\033dank_mids.helpers._weaklist\017__mypyc_attrs__\005_refs\b__dict__\bWeakList",
    "",
};
...
const int CPyLit_Tuple[] = {2, 7, 18, 19, 20, 21, 22, 23, 24, 2, 26, 13};
