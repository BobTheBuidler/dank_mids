...
PyInit__gather(void)
{
    ...
    void *init_func = PyCapsule_GetPointer(capsule, "a850d07634195e716572__mypyc.init_dank_mids___helpers____gather");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit__gather(); }
