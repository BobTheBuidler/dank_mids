...
PyInit__controllers(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_dank_mids___helpers____controllers");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "dank_mids__mypyc.init_dank_mids___helpers____controllers");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit__controllers(); }
