...
PyInit_middleware(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_dank_mids___middleware");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "a850d07634195e716572__mypyc.init_dank_mids___middleware");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_middleware(); }
