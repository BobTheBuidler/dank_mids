...
<<<<<<< HEAD
    ...
    void *init_func = PyCapsule_GetPointer(capsule, "0bf4c1c413ed1d8eb97f__mypyc.init_dank_mids____eth_utils");
=======
<<<<<<< HEAD
    ...
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "6486cd47b6f59329387b__mypyc.init_dank_mids____eth_utils");
=======
    if (!(tmp = PyImport_ImportModule("e533ac94cbe235f69297__mypyc"))) return NULL;
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_dank_mids____eth_utils");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "e533ac94cbe235f69297__mypyc.init_dank_mids____eth_utils");
