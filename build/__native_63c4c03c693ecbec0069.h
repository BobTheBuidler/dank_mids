#ifndef MYPYC_NATIVE_63c4c03c693ecbec0069_H
#define MYPYC_NATIVE_63c4c03c693ecbec0069_H
#include <Python.h>
#include <CPy.h>
...
typedef struct {
    ...
    CPyVTableItem *vtable;
    vectorcallfunc vectorcall;
} dank_mids___semaphores_____init___3_BlockSemaphore_objObject;

typedef struct {
    PyObject_HEAD
    CPyVTableItem *vtable;
    vectorcallfunc vectorcall;
} dank_mids___semaphores_____getitem___3_BlockSemaphore_objObject;
