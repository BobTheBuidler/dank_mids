...
BROWNIE_ENCODER_CACHE_MAXSIZE = int(os.environ.get("DANK_MIDS_BROWNIE_ENCODER_CACHE_MAXSIZE", 50_000))
BROWNIE_DECODER_CACHE_MAXSIZE = int(os.environ.get("DANK_MIDS_BROWNIE_DECODER_CACHE_MAXSIZE", 50_000))