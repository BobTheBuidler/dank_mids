...
def _log_exception(e: Exception) -> None:
    ...
    dont_need_to_see_errs = constants.RETRY_ERRS + ['out of gas','error processing call revert', 'non_empty_data', 'invalid ether transfer', 'exceeding --rpc.returndata.limit']
