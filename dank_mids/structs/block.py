...
class StakingWithdrawal(DictStruct, frozen=True, omit_defaults=True, repr_omit_defaults=True):  # type: ignore [call-arg]
...
class Block(TinyBlock, frozen=True, omit_defaults=True, repr_omit_defaults=True):  # type: ignore [call-arg]
    sha3Uncles: HexBytes
    miner: Address
    stateRoot: HexBytes
